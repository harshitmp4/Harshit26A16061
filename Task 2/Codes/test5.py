...
image = cv.imread('Task 2/Input/5.jpeg')
...
#ROI
def ROI(image):
    traingle = np.array([[(0,290),(380,140),(490,480)]])
...
lines = cv.HoughLinesP(roi, 0.5, np.pi/180, 20, np.array([]), minLineLength=20, maxLineGap=20)
...
cv.imwrite('Task 2/Output/5.png', final_image)
