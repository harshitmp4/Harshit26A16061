...
image = cv.imread('Task 2/Input/4.jpeg')
...
#ROI
def ROI(image):
    traingle = np.array([[(100,269),(225,150),(400,269)]])
...
lines = cv.HoughLinesP(roi, 1, np.pi/180, 20, np.array([]), minLineLength=20, maxLineGap=15)
...
cv.imwrite('Task 2/Output/4.png', final_image)
