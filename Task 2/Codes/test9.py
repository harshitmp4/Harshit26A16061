...
image = cv.imread('Task 2/Input/9.jpeg')
...
#ROI
def ROI(image):
    traingle = np.array([[(40,300),(188,100),(500,300)]])
...
lines = cv.HoughLinesP(roi, 2, np.pi/180, 35, np.array([]), minLineLength=10, maxLineGap=35)
...
cv.imwrite('Task 2/Output/9.png', final_image)
cv.waitKey(0)