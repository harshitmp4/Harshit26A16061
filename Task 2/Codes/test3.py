...
image = cv.imread('Task 2/Input/3.png')
...
#ROI
def ROI(image):
    traingle = np.array([[(0,640),(677,235),(1160,640)]])
...
lines = cv.HoughLinesP(roi, 2, np.pi/180, 100, np.array([]), minLineLength=40, maxLineGap=20)
...
cv.imwrite('Task 2/Output/3.png', final_image)  
