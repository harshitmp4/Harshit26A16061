...
image = cv.imread('Task 2/Input/2.png')
...
#ROI
def ROI(image):
    traingle = np.array([[(75,640),(500,180),(1160,640)]])
...
lines = cv.HoughLinesP(roi, 2, np.pi/180, 50, np.array([]), minLineLength=32, maxLineGap=5)
...
cv.imwrite('Task 2/Output/2.png', final_image)
