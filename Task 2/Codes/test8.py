...
image = cv.imread('Task 2/Input/8.jpeg')
...
#ROI
def ROI(image):
    traingle = np.array([[(290,300),(410,200),(578,300)]])
...
lines = cv.HoughLinesP(roi, 2, np.pi/180, 100, np.array([]), minLineLength=50, maxLineGap=10)
...
cv.imwrite('Task 2/Output/8.png', final_image)
